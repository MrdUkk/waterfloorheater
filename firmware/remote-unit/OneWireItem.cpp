    ...
    case 0x44: //tell main cycle that we need prepare new sensor readings
	    {
		    ...
		    howmuchSleep = 9; //we can safely gone to sleep for next 9*2 seconds (total 18sec, our hard defined measurement cycle is 20sec)
	    }
      break;
    ...
    case 0x4E: // WRITE our settings FROM central unit to us
      {
        ...
        if(scratchpad[8] == crc8(scratchpad, 8)) { needApplySettings = true; needSensorReadings = true; };
      }
      break;
